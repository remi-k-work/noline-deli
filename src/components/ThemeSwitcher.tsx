...
export default function ThemeSwitcher() {
  ...
  return (
    <Button type="button" size="icon" variant="ghost" className="place-self-center [grid-area:thsw]" title="Switch Theme" onClick={toggle}>
...
export function ThemeSwitcherSkeleton() {
  return <div className="bg-background h-12 w-12 animate-pulse place-self-center rounded-full [grid-area:thsw]" />;
}
