...
// types
interface ImageViewProps extends ComponentProps<"section"> {
  fieldName: string;
  fieldLabel: string;
  imageUrl?: string;
...
export default function ImageView({ fieldName, fieldLabel, imageUrl = "", onRemoveImageClicked, className, ...props }: ImageViewProps) {
  ...
  return (
    <section className={cn(styles["image-view"], className)} {...props}>
